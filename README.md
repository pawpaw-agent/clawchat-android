...
- ✅ **批量操作** - 多选删除/复制 (v1.2.0)
- ✅ **撤销删除** - 5秒内可撤销 (v1.2.0)
- ✅ **消息导出** - JSON/Text/Image (v1.2.0)
- ✅ **消息统计** - 字数统计 (v1.2.0)
- ✅ **草稿自动保存** - 24小时有效期 (v1.2.0)

#### 🎤 语音功能

- ✅ **语音输入** - SpeechRecognizer (v1.2.0)
- ✅ **消息朗读** - TTS 文本转语音 (v1.2.0)

#### 🎨 主题系统

- ✅ **主题色选择** - 8种预设颜色 (v1.2.0)
- ✅ **字体大小调整** - SMALL/MEDIUM/LARGE (v1.2.0)
- ✅ **响应式布局** - 折叠屏/大屏幕适配 (v1.2.0)
